import { Cpu, FileText, Bot, BarChart3, ChevronRight, Zap } from 'lucide-react';
...
export const AIToolsPanel = () => {
  ...
  return (
    <div className="flex-1 flex flex-col h-full bg-slate-950 p-8 overflow-hidden relative">
